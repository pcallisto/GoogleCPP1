...
int mainIostreamFormatting() {
    ...
    istr = { "1234234534564568" };
    cout << "Input: " << istr.c_str() << endl;
    ...
    cout << setw(64) << right << s1.c_str() << endl;
    cout << setw(64) << right << s2.c_str() << endl;
    cout << setw(64) << right << s3.c_str() << endl;

    cout << setfill('-') << setw(64) << right << s1.c_str() << endl;
    cout << setfill(' ') << setw(64) << right << s1.c_str() << endl;
    cout << left << s1.c_str() << endl;
